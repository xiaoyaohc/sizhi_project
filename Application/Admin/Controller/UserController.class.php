...
class UserController extends AdminController {
    ...
    public function index(){
        ...
        $list   = D('Member')->table('otk_member a')->join(' left join otk_area b on a.area_id=b.id')->join(' left join otk_teacher c on a.teacher_id=c.teacher_id')->field('a.*,b.area_name,c.teacher_name')->where($map)->select();
        int_to_string($list);
